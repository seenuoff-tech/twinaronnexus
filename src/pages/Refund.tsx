  ...
  return (
    <div className="pt-32 pb-24">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        <h1 className="font-display text-4xl font-bold mb-8 text-black">Refund & Return Policy</h1>
        <div className="prose max-w-none space-y-6 text-black text-base md:text-lg">
          <p>Last updated: May 15, 2026</p>

          <section>
            <h2 className="text-xl font-bold text-black mb-4">1. Digital Products Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-black mb-4">2. Refund Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-black mb-4">3. Technical Support</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-black mb-4">4. Duplicate Payment Handling</h2>
