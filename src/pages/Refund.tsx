    ...
    <div className="pt-32 pb-24">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-400">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4">1. Digital Products Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4">2. Refund Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4">3. Technical Support</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4">4. Duplicate Payment Handling</h2>
