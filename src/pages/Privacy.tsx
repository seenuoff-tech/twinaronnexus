  ...
  return (
    <div className="pt-32 pb-24">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        <h1 className="font-display text-4xl font-bold mb-8 text-slate-900">Privacy Policy</h1>
        <div className="prose max-w-none space-y-6 text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-4">2. Payment Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-4">4. Cookies Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 mb-4">5. Contact Information</h2>
