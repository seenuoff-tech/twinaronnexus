...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-gray-100 bg-white text-gray-800 pt-20 pb-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="max-w-sm text-sm text-gray-600 leading-relaxed font-display font-medium">
              Premium financial tracking solutions for modern business dynasties. Empowering sovereign entrepreneurs with elite data-driven insights through masterfully engineered templates.
            </p>
            <div className="mt-8 flex gap-5 items-center">
              <a 
                ...
                className="text-gray-500 hover:text-premium-yellow hover:scale-110 transition-all duration-200"
                title="Instagram"
              >
              ...
              <a href="#" className="text-gray-500 hover:text-premium-yellow hover:scale-110 transition-all duration-200" title="Twitter"><Twitter className="h-5 w-5" /></a>
              <a href="#" className="text-gray-500 hover:text-premium-yellow hover:scale-110 transition-all duration-200" title="Linkedin"><Linkedin className="h-5 w-5" /></a>
              <a href="mailto:support@twinaronnexus.com" className="text-gray-500 hover:text-premium-yellow hover:scale-110 transition-all duration-200" title="Email Support"><Mail className="h-5 w-5" /></a>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-6 font-display">Support</h3>
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name}>
                  <Link to={item.path} className="text-xs uppercase tracking-widest text-gray-600 hover:text-premium-yellow transition-colors font-display font-bold">
                    {item.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-20 border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            <p className="text-sm text-black font-display font-bold">
